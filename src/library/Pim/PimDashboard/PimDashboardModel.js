...
class DashboardModel extends BaseItemModel {
  ...
  percent_product_wattingApproval = null;
  ...
  constructor(entity) {
    ...
    if (entity) {
      ...
      this.percent_product_publish =
        entity[PIM_DASH_BOARD_DETAIL_FIELD_KEY.PERCENT_PRODUCT_PUBLISH] ?? '';
      this.percent_product_unPublish =
        entity[PIM_DASH_BOARD_DETAIL_FIELD_KEY.PERCENT_PRODUCT_UNPUBLISH] ?? '';
      this.percent_product_draft =
        entity[PIM_DASH_BOARD_DETAIL_FIELD_KEY.PERCENT_PRODUCT_DRAFT] ?? '';
      this.percent_product_Archived =
        entity[PIM_DASH_BOARD_DETAIL_FIELD_KEY.PERCENT_PRODUCT_ARCHIVED] ?? '';
      this.percent_product_wattingApproval =
        entity[PIM_DASH_BOARD_DETAIL_FIELD_KEY.PERCENT_PRODUCT_WAITTING_APPROVAL] ?? '';
      this.percent_product_trash =
        entity[PIM_DASH_BOARD_DETAIL_FIELD_KEY.PERCENT_PRODUCT_TRASH] ?? '';
    }
  }
  ...
  toJSON = () => {
    return {
      ...
      [PIM_DASH_BOARD_DETAIL_FIELD_KEY.PERCENT_PRODUCT_WAITTING_APPROVAL]:
        this.percent_product_wattingApproval,
