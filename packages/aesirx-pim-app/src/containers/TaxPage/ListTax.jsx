...
const ListTax = observer((props) => {
  const { t } = useTranslation();
  // let listSelected = [];
  const viewModel = props.model.taxListViewModel;
  useEffect(() => {
              ...
              <div>
                ...
                {/* {value.level === 1 && value?.organization_id === '0' ? (
                  ...
                  <div className="text-green">
                    <button
                      onClick={() => {
                        historyPush(`/taxs/edit/${value.id}`);
                      }}
  ...
  //   } else {
  //     viewModel.isLoading();
  //     viewModel.deleteTaxs(listSelected);
  //   }
  // };
  ...
  return (
    <div className="px-3 py-4">
      ...
      <div className="mb-3">
        ...
        >
          <Tab eventKey="default" title={t('txt_all_tax')} />
        </Tabs>
      </div>
...
export default withTranslation()(withTaxViewModel(ListTax));
