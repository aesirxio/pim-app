...
const ListShippingMethod = observer((props) => {
  const { t } = useTranslation();
  let listSelected = [];
  const viewModel = props.model.shippingMethodListViewModel;
  useEffect(() => {
              ...
              <div>
                ...
                {value.level === 1 && value?.organization_id === '0' ? (
                  ...
                  <div className="text-green">
                    <button
                      onClick={() => {
                        historyPush(`/shipping-method/edit/${value.id}`);
                      }}
  ...
  const deleteShippingMethods = () => {
    if (listSelected.length < 1) {
      ...
      viewModel.isLoading();
      viewModel.deleteShippingMethods(listSelected);
    }
  };
  ...
  return (
    <div className="px-3 py-4">
        ...
        <ActionsBar
          buttons={[
            ...
            },
            {
              ...
              variant: 'success',
              handle: async () => {
                historyPush('/shipping-method/add');
              },
            },
          ]}
        />
      ...
      <div className="mb-3">
        ...
        >
          <Tab eventKey="default" title={t('txt_all_shipping_method')} />
        </Tabs>
      </div>
      ...
      <div className="bg-white rounded">
        {viewModel?.successResponse?.state ? (
          <Table
            ...
            data={viewModel?.successResponse?.listShippingMethods}
...
export default withTranslation()(withShippingMethodViewModel(ListShippingMethod));
