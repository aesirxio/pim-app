...
const ListCustomerGroup = observer((props) => {
  const { t } = useTranslation();
  // let listSelected = [];
  const viewModel = props.model.customerGroupListViewModel;
  useEffect(() => {
              ...
              <div>
                ...
                {/* {value.level === 1 && value?.organization_id === '0' ? (
                  ...
                  <div className="text-green">
                    <button
                      onClick={() => {
                        historyPush(`/customerGroups/edit/${value.id}`);
                      }}
  ...
  //   } else {
  //     viewModel.isLoading();
  //     viewModel.deleteCustomerGroups(listSelected);
  //   }
  // };
  ...
  return (
    <div className="px-3 py-4">
        ...
        {/* <ActionsBar
          buttons={[
            ...
            },
            {
              ...
              variant: 'success',
              handle: async () => {
                historyPush('/customerGroups/add');
              },
            },
          ]}
        /> */}
      ...
      <div className="mb-3">
        ...
        >
          <Tab eventKey="default" title={t('txt_all_customer_group')} />
        </Tabs>
      </div>
      ...
      <div className="bg-white rounded">
        {viewModel?.successResponse?.state ? (
          <Table
            ...
            data={viewModel?.successResponse?.listCustomerGroups}
...
export default withTranslation()(withCustomerGroupViewModel(ListCustomerGroup));
