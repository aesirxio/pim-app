...
import { withCityViewModel } from './CityViewModel/CityViewModelContextProvider';

const ListCity = observer((props) => {
  const { t } = useTranslation();
  // let listSelected = [];
  const viewModel = props.model.cityListViewModel;
  useEffect(() => {
              ...
              <div>
                ...
                {/* {value.level === 1 && value?.organization_id === '0' ? (
                  ...
                  <div className="text-green">
                    <button
                      onClick={() => {
                        historyPush(`/citys/edit/${value.id}`);
                      }}
  ...
  //   } else {
  //     viewModel.isLoading();
  //     viewModel.deleteCitys(listSelected);
  //   }
  // };
  ...
  return (
    <div className="px-3 py-4">
      ...
      <div className="mb-3">
        ...
        >
          <Tab eventKey="default" title={t('txt_all_city')} />
        </Tabs>
      </div>
      ...
      <div className="bg-white rounded">
        {viewModel?.successResponse?.state ? (
          <Table
            ...
            data={viewModel?.successResponse?.listCitys}
...
export default withTranslation()(withCityViewModel(ListCity));
