...
import { withCountryViewModel } from './CountryViewModel/CountryViewModelContextProvider';

const ListCountry = observer((props) => {
  const { t } = useTranslation();
  // let listSelected = [];
  const viewModel = props.model.countryListViewModel;
  useEffect(() => {
              ...
              <div>
                ...
                {/* {value.level === 1 && value?.organization_id === '0' ? (
                  ...
                  <div className="text-green">
                    <button
                      onClick={() => {
                        historyPush(`/countrys/edit/${value.id}`);
                      }}
  ...
  // const deleteCountrys = () => {
  //   if (listSelected.length < 1) {
  //     notify(t('txt_row_select_error'), 'error');
  //   } else {
  //     viewModel.isLoading();
  //     viewModel.deleteCountrys(listSelected);
  //   }
  // };
  ...
  return (
    <div className="px-3 py-4">
      ...
      <div className="mb-3">
        ...
        >
          <Tab eventKey="default" title={t('txt_all_country')} />
        </Tabs>
      </div>
      ...
      <div className="bg-white rounded">
        {viewModel?.successResponse?.state ? (
          <Table
            ...
            data={viewModel?.successResponse?.listCountrys}
...
export default withTranslation()(withCountryViewModel(ListCountry));
